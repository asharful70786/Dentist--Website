  ...
  const galleryItems = [
    {
      ...
      description: 'Complete smile transformation with porcelain veneers and teeth whitening for a radiant result.',
    ...
    },
    {
      ...
      description: 'Professional whitening treatment showing dramatic improvement in tooth shade.',
    ...
    },
    {
      ...
      description: 'Restoration of missing tooth with natural-looking dental implant.',
    ...
    },
    {
      ...
      description: 'Before and after of clear aligner treatment showing improved alignment.',
    ...
    },
    {
      ...
      description: 'Our state-of-the-art treatment room with the latest dental technology.',
    ...
    },
    {
      ...
      description: 'Custom veneers creating a perfect, natural-looking smile.',
      beforeImage: 'https://tse1.mm.bing.net/th/id/OIP.yuSVocPbf2Nx2nzEqjGhxAHaDt?pid=Api&P=0&h=180',
    ...
    },
    {
      ...
      description: 'Complete smile restoration with implant-supported prosthesis.',
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-teal-500 rounded-2xl p-0.5 shadow-xl">
            <div className="bg-white rounded-xl p-8 sm:p-10">
              ...
              <button className="relative inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-teal-500 text-white font-semibold rounded-full shadow-lg overflow-hidden">
